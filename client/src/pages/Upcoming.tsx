        ...
        <div className="container mx-auto px-6 py-8 min-h-[80vh]">
          ...
          {showSuggestionForm && (
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              ...
              />
              <Card className="relative bg-gradient-to-br from-card/95 via-card/90 to-card/95 backdrop-blur-lg border border-primary/30 shadow-2xl shadow-primary/10 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <CardHeader className="border-b border-primary/20 bg-gradient-to-r from-primary/5 to-transparent">
                  <CardTitle className="text-foreground flex items-center justify-between">
                    <span className="text-primary">Request Content</span>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={handleCancel}
                ...
                <CardContent className="p-6 bg-gradient-to-br from-black/60 via-[#0A7D4B]/15 to-black/60 backdrop-blur-sm relative">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className="bg-background/50 border-primary/30 focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all duration-200"
                          required
                      ...
                      <div className="space-y-2">
                        ...
                        <Select 
                          ...
                          disabled={createDemandMutation.isPending}
                        >
                          <SelectTrigger className="bg-background/50 border-primary/30 focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all duration-200">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="suggestion-description" className="text-foreground">Additional Details (Max 1000 words) *</Label>
                      <Textarea
                        ...
                        className="bg-background/50 border-primary/30 focus:border-primary focus:ring-1 focus:ring-primary/20 min-h-[120px] transition-all duration-200"
                        disabled={createDemandMutation.isPending}
                        required
                      />
                    ...
                    <div className="flex justify-end space-x-3 pt-4 border-t border-border/30">
                      <Button 
                        ...
                        variant="outline" 
                        onClick={handleCancel}
                        className="bg-background/50 border-border/50 hover:bg-background/70 hover:scale-105 transition-all duration-200"
                        disabled={createDemandMutation.isPending}
                      >
                        Cancel
                      </Button>
                      <Button 
                        type="submit"
                        className="bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center gap-2"
                        disabled={createDemandMutation.isPending}
                      >
